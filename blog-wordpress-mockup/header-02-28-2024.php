...
<section>
    ...
    <style>
        ...
        .blog-hero-section {
            max-width: 2560px;
            background: url("https://www.sportinglife.ca/on/demandware.static/-/Library-Sites-SportingLifeSharedLibrary/default/images/homepage/slblog-header-bg-2-20-2024 1.jpg");
            background-size: cover;
            background-position: center center;
            min-height: 350px;
            margin: 0 auto;
        ...
        <div class="row">
            <div class="col-12">
                <div class="">
                    ...
                    <p class="hero-subcopy">Discover Brands, Trends, Articles & More</p>
                </div>
            </div>
        </div>
    </div>

...
.header-container__right a, .header-container__right a:hover {
    text-decoration: none;
}
...
<form class="header-search__container" role="search" action="/s/SportingLife/en-CA/search" method="get" name="simpleSearch" novalidate="novalidate">
...
<input class="header-search__input input-text no-validate" type="search" id="q" name="q" value="" placeholder="Search SportingLife.ca" autocomplete="off">
...
<section>
    ...
    <style>
        ...
        .blog-hero-section {
            max-width: 2560px;
            background: url("https://staging-na01-sportinglife.demandware.net/on/demandware.static/-/Library-Sites-SportingLifeSharedLibrary/default/images/homepage/slblog-header-bg-2-20-2024 1.jpg");
            background-size: cover;
            background-position: center center;
            min-height: 350px;
            margin: 0 auto;
    ...
    <div class="blog-hero-section">
        <div class="row">
            <div class="col-12">
                <div class="">
                    <img class="blog-logo-hero" src="/wp-content/uploads/2020/01/sl-blog-logo.png"/>
                    <p class="hero-subcopy">Discover Brands, Articles, News & More</p>
                </div>
            </div>
        </div>
    </div>

...
<style>
  .gt-blogs-main-logo {
    ...
    <!-- language switch for mobile (injected by Artur (06-07-2024)) start -->
<style>
    .mobile-nav-menu-lang {
        display: none;
        margin: 0 0 15px 0;
    }
    .mobile-nav-menu-lang ul {
        display: flex;
    ...
    .mobile-nav-menu-lang ul li a:hover {
        text-decoration: none !important;
    }
    .mobile-nav-menu-lang ul li a:hover span {
...
<ul>
 ...
 <!-- language switch for mobile (injected by Artur (06-07-2024)) end -->

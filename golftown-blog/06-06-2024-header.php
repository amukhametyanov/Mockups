	...
	<header id="masthead" class="site-header" role="banner">
		<div class="header-main">
         ...
         <h1 class="gt-blogs-main-logo">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
               <img class="en-nav" src="https://www.golftown.com/on/demandware.static/-/Library-Sites-GolfTownSharedLibrary/default/images/blog-icons/logo-golftown-blogs.svg" width="559" height="101" alt="<?php bloginfo( 'name' ); ?>"/>

               <img class="fr-nav" src="https://www.golftown.com/on/demandware.static/-/Library-Sites-GolfTownSharedLibrary/default/images/blog-icons/logo-golftown-blogs-fr.svg" width="559" height="101" alt="<?php bloginfo( 'name' ); ?>"/>
            </a>
         </h1>
